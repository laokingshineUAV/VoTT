...
<html lang="en">
<head>
    <title>Code coverage report for withAITracking.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> withAITracking.tsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
    public componentDidMount() {
      ...
      this.idleCount = 0;
&nbsp;
      this.intervalId = setInterval(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
        if (this.lastActiveTimestamp &gt; 0 &amp;&amp; this.idleStartTimestamp === 0 &amp;&amp; Date.now() - this.lastActiveTimestamp &gt;= this.idleTimeout) {
<span class="cstat-no" title="statement not covered" >          this.idleStartTimestamp = Date.now();</span>
<span class="cstat-no" title="statement not covered" >          this.idleCount++;</span>
<span class="cstat-no" title="statement not covered" >          this.debugLog("componentDidMount", "Starting idle time.");</span>
        }
      }, 100);
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        throw new Error("withAITracking:componentWillUnmount: mountTimestamp isn't initialized.");</span>
      }
&nbsp;
      if (!reactAI.appInsights) {
<span class="cstat-no" title="statement not covered" >        throw new Error("withAITracking:componentWillUnmount: ReactAI isn't initialized.");</span>
      }
&nbsp;
      if (this.intervalId) {
...
<span class="cstat-no" title="statement not covered" >        this.lastActiveTimestamp = Date.now();</span>
      }
&nbsp;
      if (this.idleStartTimestamp &gt; 0) {
        const lastIdleTime = <span class="cstat-no" title="statement not covered" >this.lastActiveTimestamp - this.idleStartTimestamp;</span>
<span class="cstat-no" title="statement not covered" >        this.totalIdleTime += lastIdleTime;</span>
<span class="cstat-no" title="statement not covered" >        this.debugLog("trackActivity", `Idle to active added ${lastIdleTime / 1000} seconds of idle time.`);</span>
<span class="cstat-no" title="statement not covered" >        this.idleStartTimestamp = 0;</span>
      }
    }
&nbsp;
    private debugLog(from: string, message: string): void {
      if (reactAI.isDebugMode) {
<span class="cstat-no" title="statement not covered" >        console.log(`withAITracking:${componentName}:${from}: ${message}`, {</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Mar 18 2019 15:48:35 GMT+0000 (Greenwich Mean Time)
</div>
</div>
