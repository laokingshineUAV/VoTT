        ...
        ApplicationInsights.prototype._onerror = function (exception) {
            try {
                ...
                if (Util.isCrossOriginError(exception.message, exception.url, exception.lineNumber, exception.columnNumber, exception.error)) {
                    ...
                    this.trackException({ error: exception.error, severityLevel: exports.SeverityLevel.Error }, properties);
                }
            }
            catch (e) {
    ...
    var SessionStorageSendBuffer = /** @class */ (function () {
        ...
        SessionStorageSendBuffer.prototype.getBuffer = function (key) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedToRestoreStorageBuffer, " storage key: " + key + ", " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
            return [];
        };
        SessionStorageSendBuffer.prototype.setBuffer = function (key, buffer) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.FailedToSetStorageBuffer, " storage key: " + key + ", " + Util.getExceptionName(e) + ". Buffer cleared", { exception: Util.dump(e) });
            }
        };
    ...
    var Sender = /** @class */ (function () {
        ...
        Sender.prototype.processTelemetry = function (telemetryItem) {
            ...
            try {
                ...
                if (!isValid) {
                    this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.TelemetryEnvelopeInvalid, "Invalid telemetry envelope");
                    return;
                }
        ...
        Sender.prototype._beaconSender = function (payload, isAsync) {
            ...
            if (queued) {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.TransmissionFailed, ". " + "Failed to send telemetry with Beacon API.");
            }
        };
        /**
         * Send XMLHttpRequest
        ...
        AjaxMonitor.prototype.instrumentOpen = function () {
            ...
            XMLHttpRequest.prototype.open = function (method, url, async) {
                try {
                    ...
                    this._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedMonitorAjaxOpen, "Failed to monitor XMLHttpRequest.open, monitoring data for this ajax call may be incorrect.", {
        ...
        AjaxMonitor.prototype.instrumentSend = function () {
            ...
            XMLHttpRequest.prototype.send = function (content) {
                try {
                    ...
                    this._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedMonitorAjaxSend, "Failed to monitor XMLHttpRequest, monitoring data for this ajax call may be incorrect.", {
                        ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(this),
                        exception: Util.dump(e)
                    });
                }
        ...
        AjaxMonitor.prototype.instrumentAbort = function () {
            ...
            XMLHttpRequest.prototype.abort = function () {
                try {
                    ...
                    this._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedMonitorAjaxAbort, "Failed to monitor XMLHttpRequest.abort, monitoring data for this ajax call may be incorrect.", {
                        ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(this),
                        exception: Util.dump(e)
                    });
                }
            ...
            xhr.ajaxData.xhrMonitoringState.onreadystatechangeCallbackAttached = EventHelper.AttachEvent(xhr, "readystatechange", function () {
                try {
                    ...
                    if (!exceptionText || exceptionText.toLowerCase().indexOf("c00c023f") == -1) {
                        _this._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedMonitorAjaxRSC, "Failed to monitor XMLHttpRequest 'readystatechange' event handler, monitoring data for this ajax call may be incorrect.", {
